            ...
            <div class="row card-title mb-4">
              ...
              <div class="col">
                <router-link
                  ...
                  :to="{ name: 'user-form', params: { id: 'add' } }"
                >Daftarkan Karyawan Baru</router-link>
              </div>
            </div>
                ...
                <table class="table center-aligned-table">
                  <thead>
                    <tr>
                      ...
                      <th class="pl-0 border-bottom-0">Email</th>
                      <th class="pl-0 border-bottom-0">Nomor Telepon</th>
                      <th class="pl-0 border-bottom-0">Jabatan</th>
                  ...
                  <tbody>
                    <tr v-for="d in datas" :key="d.id">
                      ...
                      <td class="pl-0">{{ d.email }}</td>
                      <td class="pl-0">{{ d.phone }}</td>
                      <td class="pl-0">{{ d['job-title'][0].name }}</td>
                      <td class="pr-0 text-right">
                        <router-link
                          class="btn btn-outline-success btn-sm"
                          :to="{ name: 'user-form', params: { id: d.id } }"
                        >Detil</router-link>
                      </td>
                    </tr>
                  </tbody>
