            ...
            <div class="row card-title mb-4">
              ...
              <div class="col">
                <router-link
                  ...
                  :to="{ name: 'team-form', params: { id: 'add' } }"
                >Daftarkan Tim Baru</router-link>
              </div>
            </div>
                ...
                <table class="table center-aligned-table">
                  <thead>
                    <tr>
                      ...
                      <th class="pl-0 border-bottom-0">Depo</th>
                      <th class="pl-0 border-bottom-0">Banyak Salesman</th>
                  ...
                  <tbody>
                    <tr v-for="d in datas" :key="d.id">
                      ...
                      <td class="pl-0">{{ d.depot.name }}</td>
                      <td class="pl-0">{{ d.salesmen.length }}</td>
                      <td class="pr-0 text-right">
                        <router-link
                          class="btn btn-outline-success btn-sm"
                          :to="{ name: 'team-form', params: { id: d.id } }"
                        >Detil</router-link>
                      </td>
                    </tr>
                  </tbody>
...
export default {
  ...
  methods: {
    getData () {
      let self = this
      self.$http
        .get('admin/team?page=' + self.currentPage)
        .then(resp => {
          self.loaded = true
