        ...
        <div class="card">
          <div class="card-body">
            <div class="row card-title mb-4">
              <div class="col">
                <h5>Daftar Lokasi Kantor</h5>
              </div>

              <div class="col">
                <router-link
                  class="btn btn-primary btn-sm float-right"
                  :to="{ name: 'location-form', params: { id: 'add' } }"
                >Buat Lokasi Baru</router-link>
              </div>
            </div>
                ...
                <table class="table center-aligned-table">
                  <thead>
                    <tr>
                      ...
                      <th class="pl-0 border-bottom-0">Alamat</th>
                      <th class="pl-0 border-bottom-0">Provinsi</th>
                      <th class="pl-0 border-bottom-0">Kota</th>
                  ...
                  <tbody>
                    <tr v-for="d in datas" :key="d.id">
                      ...
                      <td class="pl-0">{{ d.address }}</td>
                      <td class="pl-0">{{ d.state }}</td>
                      <td class="pl-0">{{ d.city }}</td>
                      <td class="pr-0 text-right">
                        <router-link
                          class="btn btn-outline-success btn-sm"
                          :to="{ name: 'location-form', params: { id: d.id } }"
                        >Detil</router-link>
                      </td>
                    </tr>
                  </tbody>
